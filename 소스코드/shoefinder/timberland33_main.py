...
import sys
sys.path.append('/content/my_drive/Capstone2/models')
print(sys.path)
import os
...
def get_filenames(is_training, data_dir):
  ...
  data_dir = os.path.join(data_dir, 'TIMBERLAND-batches-bin')
...
def define_cifar_flags():
  ...
  flags_core.set_defaults(data_dir='/content/my_drive/tmp/TIMBERLAND_data',
                          model_dir='/content/my_drive/tmp/TIMBERLAND_model',
                          resnet_size='56',
                          train_epochs=182,
